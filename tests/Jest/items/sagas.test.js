import { loadingWines, requestFailed, requestLoading, requestSuccess, setItems } from '../../../src/Data/Redux/ducks/items/sagas'
...
import { ItemsTypes } from '../../../src/Data/Redux/ducks/items/types';

jest.mock('../../../src/Data/services/api');
